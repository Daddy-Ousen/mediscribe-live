    ...
    >
      ...
      <div className="flex items-center justify-between pb-2 mb-2 border-b border-console-border/60">
        <div className="flex items-center gap-2">
          ...
          <span
            className={`px-1.5 py-0.2 text-xs rounded uppercase font-semibold tracking-wider ${
        ...
        <span className="text-xs text-slate-500 num-data">{toolEvent.timestamp}</span>
      </div>

      {/* Parameter Payload */}
      <div className="bg-obsidian-500 rounded p-2 text-xs space-y-1 mb-2 border border-console-border/40">
      ...
      {toolEvent.result && toolEvent.result.details && toolEvent.result.details.length > 0 && (
        <div className="bg-red-950/40 border border-red-500/30 rounded p-2.5 space-y-1.5 text-red-200 text-xs">
          ...
          <div className="text-xs text-red-400 pt-1.5 border-t border-red-500/20">
